    ...
    <>
      ...
      <main className="bg-[#f1f5f9] min-h-screen px-4 pt-10 lg:ml-[70px]">
        {isLogin ? (
              ...
              {isLoading ? (
                ...
                >
                  <button
                    ...
                    className="h-10 w-full bg-[#00bf91] text-white py-2 rounded-xl font-medium hover:bg-[#00a47c] transition duration-300 relative"
                  >
                    {loading ? (
                  ...
                  <button
                    ...
                    className="w-full border border-red-400 text-red-500 py-2 rounded-xl font-medium hover:bg-red-50 transition duration-300"
                  >
                    Delete Account
                  </button>
                  {isModalOpen && (
          ...
          <SignUpPrompt setIsOpen={setIsOpen} isOpen={isOpen} />
        )}
      </main>
    </>
  );
